...
| [搜索替换算法审计.md](./搜索替换算法审计.md) | 旧版基线、新版改进、已完成调整与后续验证项 |
...
| [VS Code 插件发布.md](./VS%20Code%20插件发布.md) | Marketplace 发布准备、打包发布步骤、上架检查清单与版权说明 |
| [0.1.0-插件市场发布归档.md](./0.1.0-插件市场发布归档.md) | 0.1.0 已发布到 Visual Studio Marketplace 的版本归档 |
