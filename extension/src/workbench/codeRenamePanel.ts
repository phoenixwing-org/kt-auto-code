...
.page{width:100%;max-width:none;margin:0;padding:12px 16px 24px}.head{display:flex;align-items:center;justify-content:space-between;gap:16px;border-bottom:1px solid var(--vscode-panel-border);padding:0 0 9px;min-height:34px}.title-line{display:flex;align-items:baseline;gap:10px;min-width:0}h1{font-size:18px;font-weight:600;line-height:1.25;margin:0;white-space:nowrap}.muted{color:var(--vscode-descriptionForeground)}.title-line .muted{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.meta{display:flex;align-items:center;justify-content:flex-end;gap:10px;min-width:0;font-size:12px;line-height:1.35}.meta #workspace{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.meta #ignore{white-space:nowrap}
.status{margin:10px 0 8px;padding:6px 9px;border-left:3px solid var(--vscode-focusBorder);background:var(--vscode-textBlockQuote-background)}.status.error{border-left-color:var(--vscode-errorForeground);color:var(--vscode-errorForeground)}
.summary{display:flex;flex-wrap:wrap;gap:5px;margin:0 0 10px}.stat{min-width:84px;padding:5px 8px;background:var(--vscode-editorWidget-background);border:1px solid var(--vscode-panel-border);border-radius:3px}.stat strong{display:inline;font-size:15px;font-weight:600}.stat span{margin-left:5px;font-size:11px;color:var(--vscode-descriptionForeground)}
...
@media(max-width:650px){.page{padding:10px}.head{align-items:flex-start;flex-direction:column;gap:5px}.meta{justify-content:flex-start;width:100%}.summary{gap:4px}.stat{min-width:80px}}
</style></head><body><main class="page">
<header class="head"><div class="title-line"><h1>搜索替换</h1><span class="muted">文本、文件名与文件夹名预览</span></div><div class="meta"><span id="workspace"></span><span id="ignore" class="muted"></span></div></header>
